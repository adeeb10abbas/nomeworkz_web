            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <form action="action.php" method="post" id="contactFrm" name="contactFrm">
                    ...
                    <input type="text" placeholder="Service Name" name="services" class="txt" required>
                    
                	 <input type="submit" value="submit" name="add_services" class="txt2">
                </form>
            </div>
            </div>
                      </div>
