        ...
        <div id="profile-details">
            <div class="background-card background-card_mobile js_functional_block">
                <div class="background-card__heading">
				  ...
				  <h1 class="orders-heading">Your Task Is Complete waiting for your approval</h1>
				  <?php 
				  $sel_pro = "SELECT * FROM `hire` WHERE clint_id='$user_id' AND staus=3";
                ...
                <div class="orders-item">
					...
					<p><a href="#" class="btn btn-success btn-sm" style="background:green;">Except</a><a href="#" class="btn btn-danger btn-sm" style="background:red;">Decline</a></p>
					</div>
