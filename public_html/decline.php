    ...
    <section id="dashboard-overview">
        ...
        <div id="account-overview">
            ...
            <div class="account-links">
                <a id="hire-writer-a" href="hire-writer.php">
                ...
                <br>
                <a id="account-orders-a" href="dashboard.php">
            ...
            <div class="background-card background-card_mobile js_functional_block">
                <div class="background-card__heading">
                    ...
                    <div class="background-card__subtitle background-card__subtitle_fz_s" style="direction: ltr;">
                        Here you can find an overview of your past orders,That tasks which Was  Not Excepted From The Groom.
                    </div>
                </div>
				  <h1 class="orders-heading">Sorry The Groom Decline This Process</h1>
				  <?php 
				  $sel_pro = "SELECT * FROM `hire` WHERE clint_id='$user_id' AND staus=1";
