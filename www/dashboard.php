...
<head>
    ...
    <meta property="og:url" content="https://nomeworkz.com/dashboard" />
                ...
                <div class="background-card background-card_mobile js_functional_block">
                    <div class="background-card__heading">
                        ...
                        <div class="background-card__subtitle background-card__subtitle_fz_s" style="direction: ltr;">
                            Feel free to update your profile below any time. Your privacy is always guaranteed, and your data is protected. This page is visible only to our support team.            </div>
                    </div>
                    ...
                    <form class="dashboard-form">
                        ...
                        <br><br>
                        <label>
                            <p style="display: inline; font-size: 12px;">Get notifications about special offers</p>
                            <input value="1" type="checkbox" name="notify_box" checked>
                        </label>
                    </form>
                </div>
            <button class="profile-details-save-btn">Save</button>
            </div>
        </section>
